const emojipedia = [
  ...
  },
  {
    ...
    meaning:
      "A yellow smiley face with closed eyes and a mouth with a subtle upward curl, shown with motion lines indicating that the smiley is shaking its head up and down vertically. ",
  },
];
